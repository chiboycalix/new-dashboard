...
function Notification({ users }) {
  ...
  var mts = users.Notifications
    ? Object.values(users.Notifications).length
    : undefined;
  ...
  const currentPosts =
    users.Notifications &&
    Object.values(users.Notifications).slice(indexOfFirstPost, indexOfLastPost);
          ...
          return (
            <div className="notification-div">
              ...
              <p className="notification-text">
                {new Date(notify.time).toDateString()}
              </p>
            </div>
          );
        })
