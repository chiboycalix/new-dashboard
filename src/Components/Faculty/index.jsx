                  ...
                  ? Object.entries(fac[1]).map((ab) => {
                      return ab[1].id === props.match.params.faculty
                        ? schoolRef
                            .child(schoolName)
                            .child(fac[0])
                            .child(props.match.params.faculty)
                            .child("Departments")
                            .child(inputValue)
                            .set({
                              id: inputValue,
              ...
              <div className="label-div">
                {
                  <div>
                    <div className="">
                      <div>
                        <span className="dep-labels">Add Department </span>
                        <br />
                  ...
                  ? Object.entries(school.Faculties).map((faculty) => {
                      return faculty[1].id === props.match.params.faculty
                        ? faculty[1].Departments
                          ? Object.values(faculty[1].Departments).map(
                              (item, i) => {
                                return (
                                  <tbody>
                                    <tr>
                                      ...
                                      <td
                                        ...
                                        onClick={() => deptUsers(item.id)}
                                      >
                                        {item.id}
                                      </td>
                                      <td>
                                        {item.Users
                                          ? Object.entries(item.Users).length
                                          : 0}
                                      </td>
                                    </tr>
                                  </tbody>
