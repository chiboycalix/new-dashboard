...
function Schools() {
  ...
  const searchResult =
    ...
    schools.filter((cr) =>
      cr.Profile
        ? cr.Profile.name.toLowerCase().includes(searchValue.toLowerCase())
        : undefined
    );
      ...
      <div className="app-div">
        <div className="school-page">
              ...
              <OverlayTrigger
                ...
                overlay={
                  <Popover id={`popover-positioned-left`} className="toolspit">
                    ...
                    <Popover.Content>
                      <p className="sort" onClick={() => setSort(true)}>
                        Ascending
                      </p>
                      <p className="sort" onClick={() => setSort(false)}>
                        Descending
                      </p>
                    </Popover.Content>
                  </Popover>
          ...
          <div className="plus" onClick={handleShow}>
            <img
              src="https://img.icons8.com/ios-glyphs/50/F07841/plus.png"
              alt=""
          ...
          <Modal show={show} onHide={handleClose}>
            ...
            <Modal.Body>
              <div>
                <label className="labels">Name of School</label>
                <br />
                <input
                  type="text"
                ...
                <label for="file" className="logo-upload">
                  Logo Uploading progress:
                </label>
              ...
              <div className="button-div">
                <button
                  ...
                  disabled={
                    schoolName === "" || institutionType === "" || urls === ""
                  }
                >
                  Add School
                </button>
          ...
          <Table responsive>
            ...
            {sort
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td
                            ...
                            onClick={() => handleRoute(school.Profile.name)}
                          >
                            {school.Profile ? school.Profile.name : undefined}
                          </td>
                          <td className="bus-name">
                            {school.Faculties
                              ? Object.keys(school.Faculties).length
                              : undefined}
                          </td>
                          {school.Posts ? (
                            <td className="bus-name">
                              {Object.keys(school.Posts).length}
                            </td>
                          ) : (
                            <td className="bus-name">0</td>
                          )}
                          <td className="bus-name">
                            {school.CAMPAIGN
                              ? Object.keys(school.CAMPAIGN).length
                              : undefined}
                          </td>
                          <td className="bus-name">
                            {school.Users
                              ? Object.keys(school.Users).length
                              : undefined}
                          </td>
                        </tr>
                      </tbody>
              ...
              : searchResult &&
                searchResult.reverse().map((school, index) => {
                  return (
                    <tbody>
                      <tr>
                        <td>{index + 1}</td>
