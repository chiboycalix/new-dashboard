...
function SchoolRoute(props) {
              ...
              Object.entries(obj[1]).map((fac) => {
                return fac[0] === "Faculties"
                  ? schoolRef
                      .child(schoolName)
                      .child(fac[0])
                      .child(faculty.school[0].faculty)
                      .set({
                        Departments: true,
  ...
  var mts =
    users &&
    users.map((user) => {
      return user.Profile?.institution === props.match.params.schoolname
        ? verb.push(user.Profile?.username)
        : "";
    });
    ...
    <div>
      ...
      <div className="app-div">
        <div className="school-page">
          ...
          >
            <span>
              <img src="https://img.icons8.com/ios-glyphs/24/000000/arrow-pointing-left--v2.png" />
            </span>{" "}
            Back
          </p>
          <div style={{ background: "white", padding: "15px" }}>
            <div className="search-div">
              <h4 className="props">
                Faculties of {props.match.params.schoolname}
              </h4>
            </div>
            ...
            <Modal show={show} onHide={handleClose}>
              ...
              <Modal.Body>
                <div className="label-div">
                  {faculty.school &&
                    faculty.school.map((schools, i) => (
                      <div>
                        <div key={i} className="">
                          <span className="labels">Name of Faculty </span>
                          <br />
                          <div className="fac-input">
                            <input
                              ...
                              value={faculty.school[i].faculty}
                            />
                          </div>
                        </div>
                      </div>
                ...
                <div className="button-div">
                  <button
                    ...
                    disabled={faculty.school[0].faculty === ""}
                  >
                    Add Faculty
                  </button>
                </div>
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td
                                  ...
                                  onClick={() => facultyDetails(faculty[1].id)}
                                >
                                  {faculty[1].id}
                                </td>
                                <td>
                                  {faculty[1].Departments
                                    ? Object.values(faculty[1].Departments)
                                        .length
                                    : null}
                                </td>
                              </tr>
