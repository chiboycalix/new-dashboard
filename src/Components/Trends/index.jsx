  ...
  trends &&
    trends.map((trend) => {
      return trend.name.toString() === selectedTrend
        ? trend.trend
          ? mts.push(Object.entries(trend.trend).length)
          : undefined
        : undefined;
    });
        ...
        <div className="trend-page">
          <div className="search-div">
            ...
            <div className="trigger">
              ...
              <input
                type="search"
                placeholder="Search by Trendname"
                        ...
                        {sort
                          ? trend.trend
                            ? Object.entries(trend.trend)
                                ...
                                .sort(
                                  (a, b) =>
                                    Object.values(a[1]).length -
                                    Object.values(b[1]).length
                                )
                                .map((tr, i) => {
                                  return (
                                    <tr>
