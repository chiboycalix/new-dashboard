...
const CustomDot = ({ background, color }) => {
  return (
    <div style={{ background }} className="custom_timeline_dot">
...
const MenuOverlay = (onClick) => (
  <Menu
    style={{ padding: 10, boxShadow: "0px 3px 6px #00000029", borderRadius: 5 }}
  >
    <Menu.Item
      style={{ padding: 10 }}
...
export const GistSection = () => {
  return (
    <div className="gist__section">
      <Timeline>
        <Timeline.Item
          className="timeline-header"
          dot={<UnorderedListOutlined className="timeline-header-icon" />}
          color="#031A2F"
        >
        ...
        >
          <div className="timeline_content">
            <div className="timeline_header">whatismunadoing</div>
            <div className="timeline_body">
              The rate of insercuirt in the Owerri is alarming and government is
              not doing..
            </div>
        ...
        >
          <div className="timeline_content">
            <div className="timeline_header">Chivic</div>
            <div className="timeline_body">
              There’s a material available for people that want to learn makeup
              check my…
            </div>
            <div className="timeline_images">
              <div className="timeline_image">
        ...
        <Timeline.Item dot={<CustomDot background="#D6F5FC" color="#00CFE8" />}>
          <div className="timeline_content">
            <div className="timeline_header">Titi</div>
            <div className="timeline_body">Who’s Interested in giveaway</div>
            <div className="timeline_images">
              <div className="timeline_image">
                <img src={ProfileImage} alt="profile" />
              </div>
        ...
        <Timeline.Item dot={<CustomDot background="#FCE4DE" color="#EB5933" />}>
          <div className="timeline_content">
            <div className="timeline_header">Chivic</div>
            <div className="timeline_body">
              There’s a material available for people that want to learn makeup
