          ...
          <div className="app-div">
            <div className="user-info-page">
              ...
              >
                <span>
                  <img
                    src="https://img.icons8.com/ios-glyphs/24/000000/arrow-pointing-left--v2.png"
                    alt=""
                  />
                </span>{" "}
                Back
                          ...
                          <div className="user-info-div1">
                            <div className="camps">
                              <div className="info-image-div">
                                <img
                                  src={user.postContent.bizzpost.cover_photo}
                                  alt=""
                              ...
                              <h4 className="info-header">
                                {user.postContent.user.username}
                              </h4>
                              <p className="info-text">
                                {user.postContent.user.institution}
                              </p>
                              <p className="info-text">
                                {user.postContent.user.dept}
                              </p>
                              <p></p>
                            </div>
                            ...
                            <div className="breakpoint">
                              <div>
                                ...
                                <p className="info-span">
                                  Plan
                                  <br />
                                  <span className="info-text">{user.plan}</span>
                                </p>
                                <p className="info-span">
                                  Duration
                                  <br />
                                ...
                                <p className="info-span">
                                  ...
                                  <br />
                                  <span className="info-text">
                                    {user.stats ? user.stats.noOfComments : 0}
                                  </span>
                                </p>
                                <p className="info-span">
                                  No. Of Likes
                                  <br />
                                  <span className="info-text">
                                    {user.stats ? user.stats.noOfLikes : 0}
                                  </span>
                                </p>
                                <p className="info-span">
                                  No. Of Regist
                                  <br />
                                  <span className="info-text">
                                    {user.stats ? user.stats.noOfRegist : 0}
                                  </span>
                                </p>
                                <p className="info-span">
                                  ClicksToPage
                                  <br />
                                  <span className="info-text">
                                    {user.stats ? user.stats.clicksToPage : 0}
                                  </span>
                                </p>
                                <p className="info-span">
                                  PhotoView
                                  <br />
                                  <span className="info-text">
                                    {user.stats ? user.stats.photoViews : 0}
                                  </span>
                                </p>
                                <p className="info-span">
                                  VideoView
                                  <br />
                                  <span className="info-text">
                                    {user.stats ? user.stats.VideoViews : 0}
                                  </span>
                                </p>
                                <p className="info-span">
                                  Date Created
                                  <br />
                                  <span className="info-text">
                                    {new Date(user.date).toUTCString()}
                                  </span>
                                </p>
                              </div>
                              <div>
                        ...
                        <Col lg="9">
                          <div className="campaign2">
                            ...
                            <p className="content-header">
                              {user.postContent.text}
                            </p>
                            <div className="array-img">
                              {Object.values(user.postContent.imgarray).map(
                                (imgs, i) => {
                                  return (
                                    <div className="arr">
                                      <div>
