...
function Campaign() {
  ...
  const price =
    campaign &&
    campaign.reduce((total, pr) => (total = total + parseInt(pr.price, 10)), 0);
          ...
          <Table responsive>
            ...
            <tbody>
              {loading ? (
                ...
                campaign
                  .filter((cr) =>
                    cr.postContent.user.username
                      .toLowerCase()
                      .includes(searchValue.toLowerCase())
                  )
                  .sort((a, b) =>
                    a.postContent.user.username.localeCompare(
                      b.postContent.user.username
                    )
                  )
                  .map((camp, i) => {
                    return (
                      <tr>
                        ...
                        >
                          {camp.postContent.user.username}
                        </td>
                        ...
                        <td className="bus-name">
                          {new Date(camp.date).toUTCString()}
                        </td>
