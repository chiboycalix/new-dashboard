            ...
            <Table responsive>
              ...
              <tbody>
                {loading ? (
                  ...
                  groups &&
                  groups.map((group) => {
                    return Object.values(group.General)
                      .filter((cr) =>
                        cr.name
                          .toLowerCase()
                      ...
                      .map((gp, i) => {
                        return (
                          <tr>
                            <td>{i + 1}</td>
                            <td>
                              <img src={gp.dp} alt="" className="group-image" />
                            </td>
                            <td>{gp.name}</td>
                            ...
                            <td>
                              <p
                                className={
                                  gp.email === "Private" ? "danger" : "success"
                                }
                              >
                                {gp.email}
                              </p>
