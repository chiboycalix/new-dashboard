...
const HeaderNav = (props) => {
  ...
  useEffect(() => {
    auth.onAuthStateChanged((user) => {
      ...
      var adminRef = firestore
        .collection("Admin")
        .get()
        .then((querySnapshot) => {
          var adminArr = [];
          console.log(
            "🚀 ~ file: index.jsx ~ line 35 ~ .then ~ adminArr",
            adminArr
          );
    ...
    <div>
      <div className="header-nav">
        <div>
          ...
          <img
            src="https://res.cloudinary.com/doouwbecx/image/upload/v1604742745/Schoolng/cir_l_2_w59sua.png"
        ...
        <div className="header-nav2">
          <NavDropdown title="Admin" id="basic-nav-dropdown">
            {user?.type === "super" ||
            currentUser?.email === "support@schooln.ng" ? (
              <>
      ...
      <div
        style={{ display: "flex", backgroundColor: "#F7F7F7", height: "100%" }}
      >
        <div>
