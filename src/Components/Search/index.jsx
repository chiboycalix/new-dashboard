          ...
          <Col>
            {schools &&
              schools.map((sch) => {
                return sch.Posts ? (
                  <div>
                    {Object.values(sch.Posts)
                      .filter(
                        (cr) =>
                          new Date(cr.date).toDateString() >=
                            new Date(parsed.start).toDateString() &&
                          new Date(cr.date).toDateString() <=
                            new Date(parsed.end).toDateString()
                      )
                      .map((scc) => {
                        return (
                          <Container fluid>
                              ...
                              <Col>
                                <div className="all-gist">
                                  <div className="">
                                    <div className="allgist-div1">
                                      ...
                                      <div className="allgist-div1-sub">
                                        <p className="allgist-div1-sub-header">
                                          {scc.user.institution}
                                        </p>
                                        <p className="allgist-div1-sub-text">
                                          Posted by {scc.user.username},{" "}
                                          {new Date(scc.date).toDateString()}
                                        </p>
                                      </div>
                                    </div>
                                    <div>
                                    ...
                                    <div className="action">
                                      ...
                                      >
                                        ...
                                        <p className="list">
                                          {scc.comments
                                            ? Object.keys(scc.comments).length
                                            : 0}{" "}
                                          comment
                                        </p>
                                      </div>
                                  ...
                                  >
                                    ...
                                    />
                                    {sendFlag.includes(scc.postid) ? (
                                      <img src="https://img.icons8.com/ios-filled/24/FF0000/flag.png" />
                                    ) : (
                                      ""
                                    )}
                                  </div>
