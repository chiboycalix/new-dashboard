        ...
        <div className="users-section">
          <div className="search-div">
            ...
            currentUser?.email === "support@schooln.ng" ? (
              <a href="/admin/create" className="btn-admin">
                Add New Admin
              </a>
            ) : null}
          </div>
                ...
                admin.map((ads, i) => {
                  return (
                    <tr>
                      <td>{i + 1}</td>
                      <td>
                        <img src={ads.image} className="admin-image" alt="" />
                      </td>
                      <td className="bus-name">{ads.fullName}</td>
                      <td className="bus-name">{ads.email}</td>
                      <td className="bus-name">
                        {ads.created_on.toDate().toDateString()}
                      </td>
                      <td className="bus-name">
                        {ads.type === "super" ? (
                          <p className="danger">Super Admin</p>
                        ) : (
                          <p className="success">Admin</p>
                        )}
                      </td>
                    </tr>
                  );
