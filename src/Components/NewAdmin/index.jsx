...
function NewAdmin() {
  ...
  const createAdmin = (e) => {
    secondAuth
      ...
      .then((result) => {
        firestore.collection("Admin").doc().set({
          fullName,
          email,
          type,
          phoneNumber,
            ...
            <div class="wrap">
              <div class="form-group">
                <label className="custom-file-upload">
                  ...
                  <img
                    src="https://res.cloudinary.com/doouwbecx/image/upload/v1618006632/Schoolng/Group_oi4rfp.png"
                    alt=""
                  />
                </label>
